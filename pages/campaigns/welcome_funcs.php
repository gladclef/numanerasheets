...
class welcome_funcs {
	public static function draw_create_column() {
		global $global_user;
		global $maindb;
	...
	public static function draw_join_column() {
		global $global_user;
		global $maindb;
	...
	public static function draw_continue_column() {
		global $global_user;
		global $maindb;
	...
	public static function draw_welcome_page() {
		global $global_user;
		global $maindb;
		...
		<div class="row">
			...
			echo "<div id='create'>".welcome_funcs::draw_create_column()."</div>";
			echo "<div id='join'>".welcome_funcs::draw_join_column()."</div>";
			echo "<div id='resume'>".welcome_funcs::draw_continue_column()."</div>";
